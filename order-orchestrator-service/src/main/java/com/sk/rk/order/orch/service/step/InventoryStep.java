package com.sk.rk.order.orch.service.step;

import com.sk.rk.events.InventoryRequestDTO;
import com.sk.rk.events.InventoryResponseDTO;
import com.sk.rk.order.orch.service.WorkflowStep;
import com.sk.rk.order.orch.service.WorkflowStepStatus;
...
public class InventoryStep implements WorkflowStep {
    ...
    public Mono<Boolean> process() {
        ...
        this.webClient
                .patch()
                .uri("/quantity-increase/"+requestDTO.getProductId()+ "/1")
